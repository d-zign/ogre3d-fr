...
?>
	...
	<div id="entry-author-info">
        ...
        <?php if ( bbp_is_user_home() || current_user_can( 'edit_users' ) ) : ?>
			...
			<span class="edit_user_link"><a class="roundbutton" href="<?php bbp_user_profile_edit_url(); ?>" title="<?php printf( __( 'Edit Profile of User %s', 'bbpress' ), esc_attr( bbp_get_displayed_user_field( 'display_name' ) ) ); ?>"><span><?php _e( 'Edit', 'bbpress' ); ?></span></a></span>

...
**************************************************************************/
	...
	class bbPressShortcodeWhitelist {
		...
		function add_filters() {
			...
			add_filter( 'bp_get_activity_content_body', 'bbp_whitelist_do_shortcode' ); //adds safe shortcodes to buddypress activity
...
//print_r($enabled_plugins);
			...
			switch($tag) {
				case 'bbpress-bbcode':
					...
					$shortcodes = array('b','i','u','s','img','url','center','quote','color','code','size','ul','ol','li','youtube','gvideo','video','spoiler');
					break;
